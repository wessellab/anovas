function stats = rm_anova1(data,alpha)
% IO adapted by JRW, Input has to be data matrix
%   (subjects(lines)*factors(columns) now
%   stats contains F,p, and eta2
