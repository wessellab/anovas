function [SSQs, DFs, MSQs, Fs, Ps]=rm_anova3(X,suppress_output)
...
% quick additions by jrw
SStot = SSbs+ERRbs+SSws+ERRws+SSint;
disp(['eta^2 for BS: ' num2str(SSbs/SStot)]);
disp(['eta^2 for WS: ' num2str(SSws/SStot)]);
disp(['eta^2 for WSxBS: ' num2str(SSint/SStot)]);
